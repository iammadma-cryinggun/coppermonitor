...
PARAMS = {
    ...
    # 做空参数
    'short_stc_overbought': 30,
    'short_stc_breakdown': -20,
    'short_stc_slope_max': -2,
    'short_cci_overbought': 100,
    'short_cci_falling_threshold': -50,
    'short_cci_zero_cross': 0,
    'short_vol_min': 0.3,
    'short_vol_max': 5.0,
    'short_atr_stop_multiplier': 1.5,
    'short_cci_oversold': -150,
}
    ...
    for i in range(len(df) - 1):
        ...
        if position_long == 0:
            ...
            if condition_stc and condition_vol and condition_cci:
                ...
                entry_atr_stop_long = entry_price - current['atr'] * params['long_atr_stop_multiplier']
        ...
        if position_short == 0:
            ...
            if condition_stc and vol_ok and condition_cci:
                entry_price = next_day['open'] * (1 - SLIPPAGE_RATE)
                entry_atr_stop_short = entry_price + current['atr'] * params['short_atr_stop_multiplier']
...
def print_results(result, params):
    ...
    print("\n" + "=" * 100)
    print("纯碱SA0 - S.C.C.系统 多空不对称v4（无分批止盈）".center(100))
    print("=" * 100)
...
def main():
    print("=" * 100)
    print("纯碱SA0 - S.C.C.系统 多空不对称v4".center(100))
    print("无分批止盈版本".center(100))
    print("=" * 100)
